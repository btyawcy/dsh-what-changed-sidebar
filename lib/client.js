window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function DiffBlock(props) {
      ...
      // 绝对行号：优先用路由补全的 content.oldStart/newStart（DSH rc.2 起的
      // applied diff 不带行号，host 用改前快照反推补全），缺失退回投影字段。
      var effOldStart = content.oldStart !== void 0 ? content.oldStart : edit.oldStart;
      var effNewStart = content.newStart !== void 0 ? content.newStart : edit.newStart;
      var built = useMemo(function () {
        return diffRows(content.oldText, content.newText, effOldStart, effNewStart);
      }, [content.oldText, content.newText, effOldStart, effNewStart]);
      ...
      var useNew = hasN && (effNewStart !== void 0 || effOldStart === void 0);
      ...
      var relative = edit.kind === "create"
        ? false
        : (useNew ? effNewStart === void 0 : effOldStart === void 0);
